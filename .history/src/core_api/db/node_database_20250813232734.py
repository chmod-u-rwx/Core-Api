...
class NodeDatabase:
    ...
    def _get_client(self) -> MongoClient[Any]:
        ...
        try:
            ...
            raise RuntimeError(f"MongoDB connection failed: {node_db_error}")
    ...
    def _ensure_indexes(self):
        ...
        try:
            ...
            raise RuntimeError(f"Index creation failed: {node_db_error}")
    ...
    def create_node(self, node_data: Dict[str, Any]) -> Node:
        ...
        try:
            ...
            raise RuntimeError(f"Database operation failed: {}")
    ...
    def get_node(self, node_id: str) -> Optional[Node]:
        ...
        try:
            ...
            raise RuntimeError(f"Database operation failed: {mongodb_error}")
