...
class NodeDataBase:
    # initialize the database connection and set up the collection
    ...
    def _initialize_collection(self):
        try: #create index on node_id for uniqueness and fast lookups
            ...
            self.logger.error(f"Failed to initialize node collection: {e}")
            raise RuntimeError(f"Error with the database: {e}")