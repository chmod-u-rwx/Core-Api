...
class RequestService:
    ...
    def get_average_execution_time(
        ...
        requests = self.list_requests(job_id, status, start_time, end_time)
    ...
    def get_average_status_requests(
        ...
        total = self.count_requests(job_id, None, start_time, end_time)
        filtered = self.count_requests(job_id, status, start_time, end_time)
